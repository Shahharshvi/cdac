...

{
  ...
  id: 8,
  text: 'You toss a fair coin three times. What is the probability of getting heads exactly twice?',
  options: [
    { id: 1, text: '1/4' },
    { id: 2, text: '3/8' },
    { id: 3, text: '1/2' },
  ...
  correctAnswerId: 2,
  explanation: 'Number of ways to get 2 heads out of 3 tosses = 3C2 = 3. Probability = 3/8.',
},
